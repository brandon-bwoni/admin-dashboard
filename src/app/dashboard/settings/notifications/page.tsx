              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3 shadow-sm">
                  <div className="space-y-0.5">
                    ...
                    <FormDescription>
                      Receive emails about your billing expenses.
                    </FormDescription>
                  </div>
                  <FormControl>
                    <Switch
          ...
          <div className="space-y-4">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3 shadow-sm">
                  <div className="space-y-0.5">
                    <FormLabel>Remainders</FormLabel>
                    <FormDescription>
                      Get notifications to remind you of updates you missed
                    </FormDescription>
                  </div>
                  <FormControl>
                    <Switch
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3 shadow-sm">
                  <div className="space-y-0.5">
                    <FormLabel>More activies about you</FormLabel>
                    <FormDescription>
                      Get all notifications for you.
                    </FormDescription>
                  </div>
                  <FormControl>
                    <Switch
