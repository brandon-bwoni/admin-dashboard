...
const SingleProductPage = () => {
  return (
    <div className="flex gap-10 mt-5">
      <div className="flex flex-col w-[30%] h-72 bg-zinc-300 p-5 rounded-xl font-bold text-gray-600 max-h-max text-lg shadow-lg ">
      ...
      <div className="w-[70%] bg-zinc-300 p-5 rounded-lg shadow-lg">
        <form className="w-full flex text-gray-700 flex-col">
          ...
          <input
            className="p-5 border-2 border-zinc-400 rounded-md bg-zinc-300 text-gray-600 mx-3 mb-3"
            type="text"
            name="title"
