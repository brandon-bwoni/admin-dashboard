    ...
    <div className="sticky h-full w-[240px]">
      ...
      <div className="bg bg-gradient-to-t from-zinc-300 to-slate-100 shadow-lg  rounded-2xl">
        ...
        <div className="flex flex-col gap-4 ">
          <span className="font-bold text-center pt-3 text-zinc-700 text-lg">
            Available now
          </span>
          <h3 className="font-medium text-[12px] text-zinc-700 px-4">
          ...
          <div className="px-4 py-4">
            <button className="flex w-16 items-center px-3 py-2 gap-1 min-w-max bg-indigo-400/50 hover:bg-indigo-400 hover:text-gray-100 rounded-xl text-sm font-medium text-gray-700">
      ...
      <div className="bg bg-gradient-to-t from-zinc-300 to-slate-100 mt-4 bg-gray-300 rounded-2xl shadow-lg">
        <div className="flex flex-col gap-4 ">
          ...
          <span className="font-medium text-[12px] text-zinc-700 px-4">
